...
public class ArrCharOps {
    ...
    */
    public static char[] concat(char[] arr1, char[] arr2) {
        ...
        //adding the arr1 valus to the new array
        for (int i = 0 ; i < arr1.length ; i++){
            newArr[i] = arr1[i];
        }
        //adding the arr2 valus to the new array
    ...
    public static long hashCode(char[] arr) {
        ...
        if (arr.length == 0){
            ...
            for (int i = 0 ; i < arr.length ; i++){
                result = result + arr[i] * ((int) (Math.pow(7, arr.length - 1 - i)));
    ...
    public static int compareTo(String str1, String str2) {
        ...
        //checking if a letter in the shorter string is smaller or greater
        //then the matching letter int the longer string
        int i = 0;
        while (i < str1.length()){
        ...
        //if the code is still running here, it means it didn't return any value - all the
        //letters in the shorter string are the same as in the longer one
        if (str1.length() == str2.length()){
            return 0;
        } else {
            return -1;
